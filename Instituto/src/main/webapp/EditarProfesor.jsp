<%-- 
    ...
    Created on : Apr 24, 2021, 8:42:58 AM
    Author     : GUSATAVO
--%>
        ...
        <div class="container" id="advanced-search-form">
            ...
            <%
               ...
               int id = Integer.parseInt(request.getParameter("id"));
                ps = conn.prepareStatement("select * from profesores where id="+id);
                rs = ps.executeQuery();
                while (rs.next()) {
            %>
            <h1>Editar Informacion Profesores</h1>
            <h2>Control Profesores</h2>    
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Estado" name="estado" id="estado" value="<%= rs.getString("estado")%>">
                </div>
...
<%
    ...
    if(nombre != null && apellido != null && dni != null && estado != null){
    ps=conn.prepareStatement("update profesores set nombre='"+nombre+"',apellido='"+apellido+"',dni='"+dni+"',Estado='"+estado+"'where id="+id);
   ps.executeUpdate();
    response.sendRedirect("Indice.jsp");}
  } catch (NullPointerException | NumberFormatException e) {
                    out.println("<h3>Editar datos del nuevo Profesor</h3>");
                } catch (Exception e) {
